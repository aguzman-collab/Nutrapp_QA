import {seccion6Home} from '../../elementos/elementos';
...
class seccion6Acciones{
    ...
    validarTransfDigital() {
        ...
        seccion6Home.obtenertextotransfodigi().should('have.text', data.TituloTransDigit) 
        })
    }

    validartransformaciondigitalparrafo(){
        cy.fixture("example").then((data) => {
            seccion6Home.obtenertextotransfoparrafoprinc().invoke('text').then(text => 
    ...
    clickbotonflecha1_SEC6(){
        seccion6Home.obtenerbotonflecha1_SEC6().click(); 
    }
    
    validarparrafoflecha1_SEC6() {
        cy.fixture("example").then((data) => {
            seccion6Home.obtenertextoflecha1_SEC6().invoke('text').then(text => 
    ...
    clickbotonflecha2_SEC6(){
        seccion6Home.obtenerbotonflecha2_SEC6().click();
    }

    validarParrafoflecha2_SEC6() {
        cy.fixture("example").then((data) => {
            seccion6Home.obtenertextoflecha2_SEC6().invoke('text').then(text => 
    ...
    clickbotonflecha3_SEC6(){
        seccion6Home.obtenerbotonflecha3_SEC6().click();
    }

    validarParrafoflecha3_SEC6() {

        cy.fixture('example').then((data) => {
            seccion6Home.obtenertextoflecha3_SEC6().each(($el, index) => { 
    ...
    clickbotonflecha4_SEC6(){
        seccion6Home.obtenerbotonflecha4_SEC6().click();
    }

    validarParrafoflecha4_SEC6() {
        cy.fixture("example").then((data) => {
            seccion6Home.obtenertextoflecha4_SEC6().invoke('text').then(text => 
    ...
    clickbotonflecha5_SEC6(){
        seccion6Home.obtenerbotonflecha5_SEC6().click();
    }

    validarParrafoflecha5_SEC6() {
        cy.fixture("example").then((data) => {
            seccion6Home.obtenertextoflecha5_SEC6().invoke('text').then(text => 
    ...
    clickbotonflecha6_SEC6(){
        seccion6Home.obtenerbotonflecha6_SEC6().click();
    }

    validarParrafoflecha6_SEC6() {
        cy.fixture("example").then((data) => {
            seccion6Home.obtenertextoflecha6_SEC6().invoke('text').then(text => 
